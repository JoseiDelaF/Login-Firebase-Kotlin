...
class CrearActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnCrearU.setOnClickListener {

            val mEmail = binding.etCorreoC.text.toString()
            val mPassword = binding.etContraseAC.text.toString()
            val mRepeatPassword = binding.etContraseAC2.text.toString()
